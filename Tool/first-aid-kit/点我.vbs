...
Call CreateShortcutOnDesktop("希沃白板 5 ", "C:\Program Files (x86)\Seewo\EasiNote5\swenlauncher\swenlauncher.exe", "C:\Program Files (x86)\Seewo\EasiNote5\swenlauncher\swenlauncher.exe", "", "C:\Program Files (x86)\Seewo\EasiNote5\swenlauncher\") '创建快捷方式